...
Inicializa el plugin y carga las clases necesarias.
Registra las páginas de usuario y administrador al activar el plugin.
...
README para Futuros Desarrollos
A continuación, se presenta un README detallado para ayudarte en futuras actualizaciones y mantenimientos del plugin.
